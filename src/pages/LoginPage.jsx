...
import GoogleAuthLoginHandler from "../components/Google/GoogleAuthLoginHandler";
import { handleGoogleLoginAuth } from "../api/api2";
          ...
          <div className="relative z-10 flex flex-col justify-center items-center text-white p-4 w-full">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="text-lg text-indigo-100 max-w-md mx-auto leading-relaxed">
                Where every view, every referral, and every interaction turns
                into real earnings
              </p>
            </div>
