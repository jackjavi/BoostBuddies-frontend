...
function SignupPage() {
  ...
  return (
    <>
      ...
      <main className=" flex min-h-screen items-center justify-center py-24 md:py-28 max-w-7xl mx-auto relative overflow-hidden">
        {/* Background Elements */}
              ...
              <div className="space-y-4">
                ...
                >
                  {isLoading ? (
                    ...
                    <span className="text-sm md:text-md font-lilita">
