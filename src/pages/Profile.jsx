...
const Profile = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 overflow-x-hidden min-h-screen py-24 md:py-28">
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-red-700">
                              Your profile is missing some important
                              information. Please complete your profile to
                              unlock all features and have a better experience.
                            </p>
                          </div>
                        </div>
                      </div>
